...
var Container = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var getClasses = function getClasses() {
    ...
    return style$1['direction-' + direction] + ' ' + alignmentClasses + getClass$1(position != '', 'position-' + position) + getClass$1(fill != '', 'fill-' + fill) + (padding != '' ? ' ' + paddingClasses : '') + (margin != '' ? ' ' + marginClasses : '') + getClass$1(color != '' && !color.includes('#'), 'color-' + color) + getClass$1(canClick, 'can-click');
  };
  ...
  var getStyles = function getStyles() {
    return _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, styles), getColor()), getPadding()), getMargin()), getWidth()), getHeight());
  };
...
function Activator(_ref6) {
  ...
  return /*#__PURE__*/React__default["default"].cloneElement(children, _objectSpread2({
    canClick: true
  }, event));
}
...
function Dropdown(_ref7) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(DropdownProvider, {
...
function aspectRatio() {
  var _useState3 = React.useState(getAspect()),
      _useState4 = _slicedToArray(_useState3, 2),
      aspect = _useState4[0],
...
function isLandscape() {
  var _useState5 = React.useState(getAspect()),
...
function isPortrait() {
  var _useState7 = React.useState(getAspect()),
