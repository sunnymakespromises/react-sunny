...
| `container`       | boolean  | `false` | `true`, `false`    | Whether or not the dropdown generates a default [Container](#container) wrapping around the component. If `false`, the component will just render its children. Generally only used when wanting to generate a default [Container](#container), see <sup>1</sup> for more details.                                                                                                                                                        |
...
| `color`     | string  | empty string | <sup>user-defined</sup>                                          | The color property of the generated text.                                                                                                                                                                                                                                                                 |    |
